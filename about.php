...
<html lang="en">
  <head>
    ...
    <title>Sparkle Clean || About Page</title>
    ...
    <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
            <div class="col-lg-6 mb-lg-0 mb-md-5 mb-4">
                <h3 class="title-small mb-2">Few words about Sparkle Clean</h3>

                <h3 class="title-big">We make Home Cleaning services simple and easy </h3>
                 <?php
...
?>
            ...
            <div class="col-lg-6 text-center">
                <div class="agileits-banner-info4">
                    <img src="assets/images/about5.jpg" alt="image" class="img-fluid radius-image" />
                </div>
            </div>
        </div>
    </div>
...
<section class="w3l-stats py-lg-5 py-4" id="stats">
    <div class="gallery-inner container py-md-5 py-4">
        ...
        <h3 class="title-big mb-md-5 mb-5">Why to Choose Us ?</h3>
        <div class="row stats-con">
         ...
         <div class="box">
          ...
          <div class="box">
            <div class="col-md-3 col-6 stats_info counter_grid">
                <div class="grids_info">
                    <span class="fa-sharp fa-solid fa-medal"></span>
                    <div class="detail">
                        <h4>Tranied Professionals</h4>
         ...
         <div class="container">
             <div class="row align-items-center">
                 <div class="main-midd col-lg-12">
                     <h3 class="title-big">We’re here to bring you the Home Cleaning Services you need.</h3>
                     <?php
