...
if(isset($_POST['submit']))
{
    ...
    // Validate date of sanitization
    if(empty($dos)){
        $errors[] = "Date of sanitization is required";
    }

    // Validate time of sanitization 
    if(empty($tom)){
        $errors[] = "Time of sanitization is required";
    }
    ...
    if(empty($errors)){
        ...
        if($query)
        {
            echo '<script>alert("Your request has been sent successfully. Your Request Number is '.$requestid.'")</script>';
        ...
        echo '<script>alert("Validation Error: '.$errorString.'")</script>';
    }
}
?>
<!doctype html>
<html lang="en">
  <head>
    <title>parkle Clean|| Request Form</title>
...
<section class="wthree-row py-5 about-main" id="contact">
    <div class="container py-lg-5 py-md-4 py-2">
        ...
        <div class="map-content-9 pt-lg-5">
            <h5 class="mb-sm-4 mb-3">Book Your Service!!</h5>
            <form method="post">
                <div class="twice-two">
